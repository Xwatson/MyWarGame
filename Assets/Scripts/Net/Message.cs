...
public class Message {
    ...
    /// </summary>
    /// <returns></returns>
    public static byte[] PickeData(RequestCode requestCode, string data)
    {
        // 转换请求code
    ...
    /// </summary>
    /// <returns></returns>
    public static byte[] PickeData(RequestCode requestCode, ActionCode actionCode, string data)
    {
        // 转换请求code
        byte[] requestCodeBytes = BitConverter.GetBytes((int)requestCode);
        // 转换方法code
        ...
        // 转换数据长度
        byte[] amountBytes = BitConverter.GetBytes(dataAmount);
        // 返回顺序，总长度 -> 请求code -> 方法code -> 数据
        return amountBytes.Concat(requestCodeBytes).Concat(actionCodeBytes).Concat(dataBytes).ToArray<byte>();
    }
}
